...
clustered_cif_band_cf <- function(scen = scen, mpple_naive_temp1 = result_temp1_naive, mpple_naive_temp2 = result_temp2_naive, times=c(0.2, 0.4, 0.8, 1.6), cause = 1, band = 1, sims = 1000){
  H <- list()
